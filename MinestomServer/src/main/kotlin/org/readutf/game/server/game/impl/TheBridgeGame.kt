...
class TheBridgeGame(
    ...
    arena: Arena<TheBridgePositions, MinestomWorld>,
    val settings: TheBridgeSettings,
    kitManager: KitManager<MinestomItemStack>,
) : Game<MinestomWorld, Arena<TheBridgePositions, MinestomWorld>, TheBridgeTeam>(platform, MinestomGame) {
    ...
    init {
        ...
        val stages: List<StageCreator<MinestomWorld, Arena<TheBridgePositions, MinestomWorld>, TheBridgeTeam>> =
            List(20) {
                StageCreator { game, previousStage ->
                    Ok(TheBridgeStage(game as TheBridgeGame, previousStage, goals, safeZones))
                }
            }
