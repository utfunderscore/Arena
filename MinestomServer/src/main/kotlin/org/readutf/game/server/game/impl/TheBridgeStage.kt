...
class TheBridgeStage(
    ...
    previousStage: Stage<MinestomWorld, Arena<TheBridgePositions, MinestomWorld>, TheBridgeTeam>?,
    goals: Map<TheBridgeTeam, Cuboid>,
    safeZones: Map<String, Cuboid>,
) : Stage<MinestomWorld, Arena<TheBridgePositions, MinestomWorld>, TheBridgeTeam>(localGame, previousStage) {
